    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,#0f172a_0%,#020617_45%,#000_90%)] p-4 sm:p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        */}
        ...
        {/* Historial (sin columna Estado, con botón ✏️ compacto) */}
        <Card className="bg-[#121212] border border-white/10">
          <CardHeader className="pb-2">
            <CardTitle className="text-slate-50 text-2xl font-semibold tracking-tight leading-none">Historial de Ponches</CardTitle>
          </CardHeader>
          <CardContent className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="text-gray-400">
              ...
              <tbody>
                ...
                <tr
                  ...
                  className="border-t border-white/5 hover:bg-white/5 transition-colors">
                    ...
                    <td className="text-slate-50 pr-4 py-2">{t.employee_name}</td>
                    <td className="text-slate-50 pr-4 py-2">{t.clock_in ? fmt(t.clock_in) : "—"}</td>
                    <td className="text-slate-50 pr-4 py-2">{t.clock_out ? fmt(t.clock_out) : "—"}</td>
                    ...
                    <button
                      ...
                      className="p-2 rounded-md bg-zinc-800 hover:bg-zinc-700 text-slate-100 transition-all active:scale-95"
                      title="Editar ponche">
                    ...
                    <span
                      className="inline-flex items-center justify-center text-gray-500 text-xs"
                      title="Solo admin">
