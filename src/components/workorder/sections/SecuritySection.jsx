  ...
  return (
    <>
        ...
        <CardContent className="space-y-4">
          ...
          {security.pattern_image && (
            <div className="pt-4 border-t border-gray-800">
              <label className="text-sm text-gray-400 mb-2 block">Patrón de desbloqueo</label>
              <Button
                variant="outline"
          ...
          {!security.device_password && !security.device_pin && !security.pattern_image && (
      ...
      <Dialog open={showPatternModal} onOpenChange={setShowPatternModal}>
        ...
        >
          <DialogHeader>
            <DialogTitle className="text-white">Patrón de desbloqueo</DialogTitle>
          </DialogHeader>
