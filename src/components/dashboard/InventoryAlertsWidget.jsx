...
export default function InventoryAlertsWidget() {
  ...
  const getStockStatus = (item) => {
    ...
    if (stock === 0) {
      return { label: "Agotado", color: "bg-red-600/20 text-red-300 border-red-600/30" };
    }
    return { label: "Bajo", color: "bg-amber-600/20 text-amber-300 border-amber-600/30" };
  };
      ...
      <CardContent>
        {loading ? (
          ...
          <div className="text-center py-6">
            ...
            <p className="text-gray-400 text-sm">Todo el inventario está bien abastecido</p>
          </div>
        ) : (
